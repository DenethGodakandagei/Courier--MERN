...
const International = () => {
  ...
  const handleClick1 = () => {
    if(weight <= 0 || country ===""){
      toast.error("Enter Package Details !", {
  ...
  const handleClick2 = () => {
    if(sendername === "" || sendernumber === "" || senderaddress === "" ){
      toast.error("Enter Sender Details !", {
        position: toast.POSITION.TOP_CENTER,
      });
    }
    else{
  ...
  const handleClick3 = () => {
    ...
    axios
      .post("http://localhost:5001/oder/international", data)
      .then((response) => {  
        const newreqId = response.data.id;
        console.log(newreqId);
        navigate(`/order/international/${newreqId}`)  
                ...
                <div className="h-[300px] mt-12 lg:mt-0 ">
                  ...
                  <div className={isActive1 ? "activeamount" : ""}>
                    <div className="max-w-sm mx-auto max-h-sm pr-4">
                      ...
                      <div className="py-5">
                        <span className="font-bold ">Select Receiver Country:-</span>
                      </div>
                      <div className=''> <Select className="bg-gray-100" options={options} value={country} onChange={changeHandler} /></div>
                    ...
                    <form className="max-w-sm mx-auto max-h-sm mr-5 sm:ml-[105px] mt-[-425px]">
                      ...
                      <div className="mb-5">
                        ...
                        <input
                          ...
                          onChange={(e) => setReceivernumber(Number(e.target.value))}
